...
class LANG:
    ...
    NAME_EMPTY = "Tunnel name cannot be empty."
    NAME_IN_USE = "Tunnel '{}' already exists."
    SSH_ERROR = "SSH tunnel '{}' failed to start."
    SSH_EXITED = "SSH tunnel '{}' closed unexpectedly (exit code {})."
