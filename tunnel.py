...
################################################################################
## Form generated from reading UI file 'tunnel.ui'
##
...
class Ui_Tunnel(object):
    def setupUi(self, Tunnel):
        ...
        self.action_tunnel.setFocusPolicy(Qt.NoFocus)
        icon1 = QIcon()
        ...
        self.action_open.setFocusPolicy(Qt.NoFocus)
        icon2 = QIcon()
        ...
        self.action_settings.setMaximumSize(QSize(32, 32))
        self.action_settings.setFocusPolicy(Qt.NoFocus)
        icon3 = QIcon()
